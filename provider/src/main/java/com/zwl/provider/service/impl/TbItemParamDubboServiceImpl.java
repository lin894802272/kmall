...
import com.zwl.provider.mapper.TbItemParamMapper;
@Service(timeout =4000, version = "1.0.0",interfaceClass = TbItemParamDubboService.class)   //dubbo service注解，需要指定版本,并告述它要实现那个接口,然后消费者消费的时候，需要指定版本号
