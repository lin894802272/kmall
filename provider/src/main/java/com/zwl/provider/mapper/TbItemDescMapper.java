...
import com.kmall.pojo.TbItemDescExample;
...
public interface TbItemDescMapper {
    ...
    int updateByExampleSelective(@Param("record") TbItemDesc record, @Param("zwl") TbItemDescExample example);

    int updateByExampleWithBLOBs(@Param("record") TbItemDesc record, @Param("zwl") TbItemDescExample example);

    int updateByExample(@Param("record") TbItemDesc record, @Param("zwl") TbItemDescExample example);
