...
public interface TbItemParamItemMapper {
    ...
    int updateByExampleSelective(@Param("record") TbItemParamItem record, @Param("zwl") TbItemParamItemExample example);

    int updateByExampleWithBLOBs(@Param("record") TbItemParamItem record, @Param("zwl") TbItemParamItemExample example);

    int updateByExample(@Param("record") TbItemParamItem record, @Param("zwl") TbItemParamItemExample example);
