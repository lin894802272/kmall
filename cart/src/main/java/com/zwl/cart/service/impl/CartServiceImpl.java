package com.zwl.cart.service.impl;
...
import com.zwl.cart.service.CartService;
...
public class CartServiceImpl implements CartService {
	...
	public EgoResult update(long id, int num,HttpServletRequest request) {
		...
		String ok = jedisDaoImpl.set(key, JsonUtils.objectToJson(list)); //redis修改成功就会返回ok的字符串
